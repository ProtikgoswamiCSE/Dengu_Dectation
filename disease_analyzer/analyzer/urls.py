...
urlpatterns = [
    ...
    path('analyze-warning/', views.analyze_warning, name='analyze_warning'),
    path('analyze-symptoms-warning/', views.analyze_symptoms_warning, name='analyze_symptoms_warning'),
